...
subtitle: "MGMT 648 &middot; Session 1"
author: "Kerry Back"
date: "2026-08-27"
format:
  revealjs:
...
Everything is posted at [mgmt648.kerryback.com](http://mgmt648.kerryback.com).
...
Welch's *Corporate Finance*, Damodaran's materials
:::
:::
...
| Currency | Dollar sign, commas, no decimals: \$1,234,567 |
| Units | Stated in the header, not in every cell: Revenue (\$mm) |
| Percentages | One decimal: 12.4%. Valuation multiples as 8.5x |
...
Put the loan amount, rate, and term in labeled input cells at the top. 
Include a chart of the amount going to interest and the amount going to principal each month.
